    ...
    <section className="bg-[#DBEDF6] py-16 sm:py-20 md:py-24 shadow-md">
      <div className="container mx-auto max-w-5xl px-6 text-center space-y-10">
        <div className="space-y-3">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-foreground/80">
            Set Up Your Account
          </h2>
        ...
        {account && (
          <div className="flex justify-center">
            <Button className="flex items-center gap-2 sm:gap-3 rounded-full h-12 sm:h-14 px-6 sm:px-8 transition-transform hover:scale-105">
              <span className="text-base sm:text-lg font-medium text-primary-foreground">
                Wallet Connected
              </span>
